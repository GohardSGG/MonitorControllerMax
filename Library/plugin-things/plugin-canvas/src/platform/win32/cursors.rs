use windows::Win32::UI::WindowsAndMessaging::{
    ...
    IDC_SIZEALL, IDC_SIZENESW, IDC_SIZENS, IDC_SIZENWSE, IDC_SIZEWE, IDC_WAIT, IMAGE_CURSOR,
...
impl Cursors {
    ...
    fn load_cursor(name: PCWSTR) -> HCURSOR {
        let handle = unsafe { LoadImageW(None, name, IMAGE_CURSOR, 0, 0, LR_SHARED).unwrap() };
